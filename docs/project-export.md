...
from rooms the caller can access, retained transcripts, and Markdown documents.
...
Missing artifact bytes or corrupt transcript chunks abort the export.
...
repository and transcript object store before checking the downloaded archive.
