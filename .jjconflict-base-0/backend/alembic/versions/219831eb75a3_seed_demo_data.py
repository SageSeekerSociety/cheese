...
def upgrade() -> None:
    ...
    vals = ", ".join(f"({tid}, '{name}', 1, {NOW})" for tid, name in topics)
    op.execute(f"""
    ...
    teams = [
        (
            ...
            "深度学习研究组",
            "探索前沿 AI 技术",
            "专注于深度学习模型研究与实践，包括 CV、NLP、强化学习等方向。",
            2,
        ),
        (
            2,
            "全栈开发小队",
            "从前端到后端一把梭",
            "涵盖 Vue、React、FastAPI、Spring Boot 等技术栈的全栈实践团队。",
            3,
        ),
        (
            3,
            "数据分析兴趣组",
            "用数据讲故事",
            "学习数据分析、可视化和统计建模，定期进行 Kaggle 比赛。",
            4,
        ),
    ]
    ...
    spaces = [
        (
            ...
            "人工智能实践空间",
            "AI 学习与实践的综合平台",
            "这里汇聚了各种 AI 相关的任务和挑战，从入门到进阶，欢迎参与！",
            2,
        ),
        (
            2,
    ...
    q_topics = [
        (1, 1, 1, 3),
        (2, 1, 5, 3),  # Q1: 深度学习, 计算机视觉
        (3, 2, 3, 4),  # Q2: Web 开发
        (4, 3, 9, 5),  # Q3: 数据库
        (5, 4, 8, 6),  # Q4: 开源项目
        (6, 5, 7, 7),
        (7, 5, 3, 7),  # Q5: 云计算, Web 开发
    ]
    ...
    answers = [
        (
            ...
            1,
            1,
            "我推荐 PyTorch，社区活跃、调试方便，特别适合研究和快速原型。"
        ...
        (
            ...
            1,
            2,
            "JAX 也值得关注，特别是在需要高性能数值计算和自动微分的场景下。"
    ...
    knowledges = [
        (
            1,
            "PyTorch 入门教程汇总",
            "收集整理的 PyTorch 官方和社区优质教程",
            "TEXT",
            '{"text": "包含官方教程、动手学深度学习、PyTorch Lightning 等资源链接"}',
            1,
            1,
        ),
        (
            2,
            "FastAPI 项目最佳实践",
            "FastAPI 项目结构、依赖注入和测试的最佳实践总结",
            "TEXT",
            '{"text": "项目结构建议采用 domain-driven 分层，使用 Depends 做依赖注入"}',
            2,
            2,
        ),
        (
