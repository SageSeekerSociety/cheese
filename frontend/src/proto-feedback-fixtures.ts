...
function performanceStats(): Record<string, unknown> {
  const routes = [
    ...
    { method: 'POST', route: '/topics/{topic_id}/messages', status: '200', count: 54, p50: 41.3, p95: 122.6, p99: 251.9 },
    { method: 'GET', route: '/admin/stats/feedback', status: '200', count: 31, p50: 9.8, p95: 24.1, p99: 38.7 },
    // 刚加过路由、还没人访问过的那一条：分位数是 null，页面画「—」。
    { method: 'GET', route: '/spaces/{space_id}/discussions', status: '200', count: 0, p50: null, p95: null, p99: null },
  ]
  return {
