    ...
    <div class="fb-admin-drawer__inner">
      ...
      <div v-if="item" class="fb-admin-drawer__body">
        ...
        <!-- 安全问题这一格单独放，且写成一句话说明后果：勾上之后这条对**同事**
             就不见了（服务端把它收窄到私密那一档），不是加了个标签。它收窄的是
             「公开」那一档，不是房间那一档——提出它的那个房间里的人本来就看过它的
             内容，对他们藏起来藏不掉任何东西，所以文案不能说「只有提交者和管理员」。 -->
        <section class="fb-section">
          <div class="t-eyebrow mb-1">安全问题</div>
          <div class="t-meta mb-2">
            标成安全问题之后，这条按私密处理：只有提交者、平台管理员、以及提出它时在那个房间里的人看得到；别人打开它只会看到「打不开」。
          </div>
          <v-switch
