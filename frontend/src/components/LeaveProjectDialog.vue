...
// 「退出项目」的确认框。入口现在有两个：成员页右上角那颗按钮，和项目名旁边那个
// 菜单里的一行（#6：成员页刚被壳收进那个菜单，而按钮只长在成员页上，跟着一起藏
// 了两层深，项目 lead 都找不到）。入口可以有多处，但「点了之后发生什么」只有一
// 份：确认、DELETE /projects/{id}/membership、刷新名册和项目列表、离开这个项目。
// 所以这一份动作住在这里，两个入口都只是把它打开。
