      ...
      <v-card-text>
        ...
        <div id="information-collection" class="policy-section mb-8">
          ...
          <div class="section-content">
            ...
            <p class="text-body-2 mb-4">
              对于需要实名认证的题目和项目，我们会收集您的真实姓名、学号、年级、专业和班级等信息。
        ...
        <div id="information-usage" class="policy-section mb-8">
          ...
          <div class="section-content">
            ...
            <h4 class="text-subtitle-2 font-weight-medium mb-2">题目参与</h4>
            <p class="text-body-2 mb-4">
              对于需要实名认证的题目，我们会使用您的实名信息进行资格验证、结果认证和奖项发放等。
        ...
        <div id="user-rights" class="policy-section">
          ...
          <div class="section-content">
            ...
            <p class="text-body-2 mb-0">
              您可以控制哪些题目和项目能够使用您的实名信息，并可随时撤销或限制授权。
              在信任与隐私中心，您可以详细了解所有需要实名信息的题目并进行管理。
            </p>
          </div>
        </div>
      </v-card-text>
