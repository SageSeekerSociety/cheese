<template>
  <v-sheet flat rounded="lg" class="member-page">
    <div class="member-page__hero">
      <div>
        <h1 class="member-page__title">我发布的题目</h1>
      </div>

      <v-btn color="primary" rounded="lg" prepend-icon="mdi-plus" @click="navigateToPublishTask">发布题目</v-btn>
    </div>
