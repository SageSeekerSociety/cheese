    ...
    CLAUDE_CODE: Harness(
        ...
        subagents={
            SubagentRequirement.SPAWNS_WITH_A_MODEL: (
                ...
                "project child default or project main default. The fetch preload "
                "carries the chosen model to backend admission, which validates the "
                "catalog and tier policy before either supply pool forwards it. "
