...
The prototype (`frontend/src/lib/feedbackMock.ts` + `views/feedback/*`) is the
spec; `docs/topics/反馈功能后端设计-方案稿.md` is the design this implements.
...
class Feedback(UuidPk, Timestamps, Base):
    ...
    display_no: Mapped[int] = mapped_column(Integer, feedback_seq, nullable=False)
