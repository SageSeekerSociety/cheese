...
async def _type_named(session: AsyncSession, *, name: str, model: str | None):
...
def test_type_that_names_a_model_reports_it(
...
def test_type_that_names_no_model_declines_rather_than_defaults(
    db_session: AsyncSession, _portal: "BlockingPortal"
):
...
def test_unknown_type_declines_too(db_session: AsyncSession, _portal: "BlockingPortal"):
...
def test_the_agent_carries_its_types_model(
    db_session: AsyncSession, _portal: "BlockingPortal"
):
