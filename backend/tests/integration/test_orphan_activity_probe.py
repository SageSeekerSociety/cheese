...
@pytest.mark.anyio
async def test_last_block_at_reports_the_newest_block_per_topic(business_db_factory):
...
@pytest.mark.anyio
async def test_last_block_at_is_empty_for_no_topics(business_db_factory):
