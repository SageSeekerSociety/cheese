...
def _worker_starts(client, room_id: str, task_id: str, agent_id: str) -> None:
...
def test_the_landed_commit_names_the_agent_and_every_worker_declared(client):
    ...
    _worker_starts(client, room, mine, "ac2c038d44616a2f2")
    _worker_starts(client, room, theirs, "9f1b7c22e0d341a80")
...
def _two_batches(client) -> tuple[str, str, str, str]:
    ...
    _worker_starts(client, room, earlier, "aaaa0000aaaa0000a")
    _worker_starts(client, room, later, "bbbb1111bbbb1111b")
...
def test_a_placeholder_task_that_wrote_no_code_is_never_signed_on(client):
    ...
    _worker_starts(client, room, real, "cccc2222cccc2222c")
...
def test_work_still_running_is_not_signed_onto_the_batch_going_out_now(client):
    ...
    _worker_starts(client, room, done, "dddd3333dddd3333d")
    _worker_starts(client, room, running, "eeee4444eeee4444e")
